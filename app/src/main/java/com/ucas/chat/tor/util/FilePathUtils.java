...
//   public final static String USER_INFO_FILE = "/sdcard/Chat/UserA";
// public final static String USER_INFO_FILE = "/sdcard/Chat/UserB";
 //public final static String USER_INFO_FILE = "/sdcard/Chat/UserC";
  public final static String USER_INFO_FILE = "/sdcard/Chat/UserD";
    ...
    public final static String RECIEVE_FILE_PATH = "/data/data/com.ucas.chat/files/ReceiveFile/";
     ...
     public final static String OFF_LINE_FILE_PATH =  "/sdcard/Android/data/com.ucas.chat/files/";

    //临时存储加密文件路径
    public final static String TEMP_FILE =  "/sdcard/Chat/TempFile/";
}
