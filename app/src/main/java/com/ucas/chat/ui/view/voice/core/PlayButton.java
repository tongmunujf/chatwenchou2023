package com.ucas.chat.ui.view.voice.core;
...
import com.ucas.chat.utils.Settings;
...
public class PlayButton extends Button implements View.OnClickListener,
    ...
    private void setPlayIcon() {
        if (mode == 2) {
            setBackgroundResource(R.mipmap.record_play_animate_03);
        } else if (mode == 1) {
            setBackgroundResource(R.mipmap.icon_iamge_audio_widget_play);
        } else {
            setBackgroundResource(R.mipmap.record_play);
        }
    }
    ...
    private void setPauseIcon() {
        ...
        if (mode == 2) {
            ...
            setBackgroundResource(R.mipmap.icon_iamge_audio_widget_playpause);
        } else {
            setBackgroundResource(R.mipmap.record_pause);
        }
    }
    ...
    private int resId = R.mipmap.icon_iamge_audio_widget_play_bg;
