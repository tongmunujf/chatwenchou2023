...
import com.ucas.chat.ui.view.voice.core.PlayButton;
import com.ucas.chat.ui.view.voice.core.Player;
...
public class PlaySoundTouchWidget extends FrameLayout implements
    ...
    private int[] effectBack = new int[]{
            R.mipmap.icon_trnsfer_effect_origin,
            R.mipmap.icon_trnsfer_effect_girl,
            R.mipmap.icon_trnsfer_effect_father,
            R.mipmap.icon_trnsfer_effect_boy,
            R.mipmap.icon_trnsfer_effect_yellow,
            R.mipmap.icon_trnsfer_effect_baby
    };
